...
def local_univariate_lstm_keras_pipeline(
    ...
    return Pipeline(
        steps=[
            ...
            ("replace outliers with interploated values", market_processing.replace_outliers, {}),
            ...
            (f"Decompose training data into STL trend, season and residuals", market_processing.decompose_time_series, {}),
