...
And the p-values are presented in \Cref{table:ttest-p-values-variance-experiments-MASE},
and \Cref{table:ttest-p-values-variance-experiments-sMAPE}.
The results are also visualized in \Cref{fig:results:boxplot-dataset-variance}.
...
as shown in \Cref{table:ttest-p-values-differencing-experiments-MASE}.
