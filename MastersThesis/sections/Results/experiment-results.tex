...
\todo[inline]{Update table description \Cref{table:ttest-p-values-main-experiments-sMAPE}: Compares the CNN-AE-LSTM against its LSTM model structure counter partner}
