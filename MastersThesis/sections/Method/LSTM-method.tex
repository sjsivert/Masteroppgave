...
and the parameters used in the dense layer are listed in \Cref{table:LSTM-dense-cell-parameters}.
...
batches had to be the same size. Our time series were concatenated one after
...
We counted how many batches it had run. When the number of batches ran equals
...
samples is too late. Still, this technique did prove to be successful.
