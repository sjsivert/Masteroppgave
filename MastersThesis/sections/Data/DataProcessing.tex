...
Since the E-commerce domain are heavily influence by external factors, such as
holidays, christmas, and yearly seasons we thought it would be benefitual
for the neural net models to be aware which day of the week it is,
which month it is, and if it is closer to summer of winter.
...
\Cref{fig:season-feature} show the output of the season feature.
