...
The presented model is a Convolutional autoencoder with a LSTM.
...
The model is intended to work with highly fluctuating datasets. The results of the thesis show a decrease in predictive error with the hybrid method over a LSTM model.
...
a LSTM benchmark should be established to verify that the new model indeed surpasses the LSTM method.
