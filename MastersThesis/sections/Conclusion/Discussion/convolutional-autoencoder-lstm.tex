...
While these assumptions are dificult to test and prove in the given state of afears,
this is an important point for further investigation and work with the hybrid model in order
to test and verrify its viablity of use in other context or problems.
