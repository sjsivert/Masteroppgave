...
Additionally, pressense of noise in the dataset is unclear.
While the dataset from prisguiden is comprised of multiple datasets with varrying degree of noise,
the datasets available to \cite{Zhao2019} could be more suited for use of the autoencoder
due to the pressense of noise in the dataset.
...
improvements to the error metric values, this is in large parts dependent on different factors such as the available dataset.
