...
% ....
% Dataset   -   LSTM   -  CNN
% Dataset 1 -  0.239   -  0.208 ->  13%
% Dataset 2 -  0.633   -  0.716 ->  -11.6%
% Dataset 3 -  0.488   -  0.483 ->  1.03%
...
% Why is this?
% --> Do we have a clear idea of why the performance is not better?
...
\todo[inline]{Why is the performance so bad?}
...
% Dataset 2 -  0.662   -  0.675   ->  -1.93 %
% Dataset 3 -  0.464   -  0.417   ->  10.2 %
...
% Dataset 2 -  0.603   -  0.743  ->  -19%
% Dataset 3 -  0.325   -  0.354  ->  -8.2%
...
% Dataset 2 -  0.642   -  0.703  ->  -8.7%
% Dataset 3 -  0.447   -  0.566  ->  -21%
