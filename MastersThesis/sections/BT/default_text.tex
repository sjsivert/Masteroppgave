...
\begin{tcolorbox}[width=\linewidth, sharp corners=all, colback=white!96!black]
    ...
    The bulk of citations in the report will appear in \Cref{cit}. However, you will often need to introduce some terminology and key citations already in this chapter.
