...
White noise is just a random sample of numbers not following any pattern, as seen in
...
\Cref{eq:random_walk}, where $r$ is some random number, shows the equation for creating a random walk.
...
\Cref*{fig:dataset:random_walk_decomposed} illustrates a random walk decomposed into trend, seasonality, and residual values.
...
This will leave only the noise $r$ in \Cref{eq:random_walk}.
