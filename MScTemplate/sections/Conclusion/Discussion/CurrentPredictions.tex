...
too much expertise.
\todo[inline]{"God old..." ville kanskje omformulert. Holder det å si simple, eller blir det å underdrive? Kanskje heller kjapt peke på feilene slik som under?}
...
\todo[inline]{Legge til refferanse til dette. Er forklart i teorien, så å referere til det sammtidig som dette er gull.}
...
\todo[inline]{Alt dette er forklart tidligere. Fantastisk skrevet, kort og konsist og akkurat sånn det bør være. Men legg til refferanser til tidligere seksjoner når vi kommer med klart testbare påstander!}
