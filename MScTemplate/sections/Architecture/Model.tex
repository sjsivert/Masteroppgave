...
\todo[inline]{List the use of local, global and multivariate methods that should be used.}
\todo[inline]{Reference the use of benchmarks! Add a paragraph about what methods should be used for benchmarks. As statistical method, use ARIMA, as ML method use LSTM}
