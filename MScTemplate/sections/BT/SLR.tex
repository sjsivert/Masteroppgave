...
\todo[]{Fix itemize breaking compile}
%\begin{itemize}
...
%    \item QC 7	Is the test data set reproducible?
%    \item QC 8	Is the experimental procedure throughly explained and reproducible?
%    \item QC 9	Is it clearly stated in the study which other algorithms the study’s algorithm(s) have been compared with?
